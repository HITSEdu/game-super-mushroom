...
const Button = ({
  ...
  return (
    <motion.button
      className={`group gap-2.5 flex-center h-mobile:rounded-xl rounded-2xl font-bold
                transition-all duration-300 shadow-lg border-4 h-mobile:border-3 relative
    ...
    >
      {!disabled && (
        <div
          className={`rounded-xl absolute inset-0 bg-gradient-to-r ${textGradientClass ?? "from-sky-500"}
      ...
      {!disabled && (
        <div className="absolute inset-0 overflow-hidden">
          <div
            className="absolute -inset-y-full -left-20 w-20 bg-gradient-to-r from-transparent
