...
const MobileControls = () => {
    ...
    return (
        <div className="fixed bottom-4 left-0 right-0 flex justify-between items-end px-4 z-50 pointer-events-none">
            <div className="flex gap-4 pointer-events-auto">
                <button
                    className="w-20 h-20 rounded-4xl bg-gray-800 text-white flex-center active:bg-gray-600"
            ...
            <div className="pointer-events-auto">
                <button
                    className="w-20 h-20 rounded-4xl  bg-blue-700 text-white flex-center active:bg-blue-500"
